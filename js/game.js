...
window.addEventListener("load", function () {
  ...
  try {
    if (!_0x4920fc || !_0x4920fc.db) {
      console.warn("Socket send skipped: db is null");
      return false;
    }

    if (_0x4920fc.db.readyState !== WebSocket.OPEN) {
      console.warn("Socket send skipped: readyState =", _0x4920fc.db.readyState);
      return false;
    }

    if (
      !(_0x3f720b instanceof ArrayBuffer) &&
      !(typeof _0x3f720b === "string") &&
      !(_0x3f720b instanceof Blob) &&
      !ArrayBuffer.isView(_0x3f720b)
    ) {
      console.warn("Socket send skipped: invalid payload");
      return false;
    }
    ...
    try {
      if (typeof _0x4920fc.Ub === "function") {
        _0x4920fc.Ub();
      }
    } catch (_0xinnerErr) {
      console.log("Socket cleanup error: " + _0xinnerErr);
    }
    return false;
  }
};
          ...
          if (_0x17fdf8 && _0x17fdf8.user_data) {
            ...
            for (var _0x5b5e30 = 0; _0x5b5e30 < clientes.clientesActivos.length; _0x5b5e30++) {
              ...
              if (theoKzObjects.FB_UserID == 0) {} else if (theoKzObjects.FB_UserID == _0x531c0d) {
                $(".column-left").append("<div class='het-han'> Aktivasyon SÃ¼resi : " + _0x490b16 + "</div>");
                _0x4d329b();
                _0x144f9f();
              } else {}
            }
...
(function (_0x156165, _0xfd9810) {
  ...
  const _0x50f390 = _0x156165();
  while (true) {
    try {
      const _0x352375 = -parseInt(_0x5b7aa3(184)) / 1 + -parseInt(_0x5b7aa3(199)) / 2 * (-parseInt(_0x5b7aa3(208)) / 3) + parseInt(_0x5b7aa3(206)) / 4 + parseInt(_0x5b7aa3(186)) / 5 + parseInt(_0x5b7aa3(194)) / 6 * (parseInt(_0x5b7aa3(189)) / 7) + -parseInt(_0x5b7aa3(198)) / 8 * (parseInt(_0x5b7aa3(201)) / 9) + parseInt(_0x5b7aa3(185)) / 10 * (-parseInt(_0x5b7aa3(182)) / 11);
...
async function fetchBadWords() {
  ...
  const _0x18f62c = _0x32bc5d(195);
  try {
    const _0x57690d = await fetch(_0x18f62c);
    if (!_0x57690d.ok) {
      throw new Error(_0x32bc5d(190));
    }
    const _0x385a26 = await _0x57690d[_0x32bc5d(204)]();
    console[_0x32bc5d(200)](_0x32bc5d(209), _0x385a26);
    return _0x385a26[_0x32bc5d(181)]("\n")[_0x32bc5d(202)](_0x34af5d => _0x34af5d[_0x32bc5d(203)]()[_0x32bc5d(183)]())[_0x32bc5d(207)](_0x2bb2c3 => _0x2bb2c3 !== "");
  } catch (_0x4d6d31) {
    console.error(_0x32bc5d(188), _0x4d6d31);
    return [];
  }
}
function _0x1cde() {
  const _0x4beed6 = ["filter", "18HrnISE", "Fetched bad words:", "length", "split", "319UgLyun", "toLowerCase", "41282wNeaap", "154000lAOjkD", "3123705zahKnI", "getElementById", "Fetching bad words failed:", "14KrmDxM", "Network response was not ok", "value", "No bad words loaded", "mm-params-nickname", "1649736kFMYUq", "https://wormatefriendsglobal.com/kufur.txt", "addEventListener", "input", "32RyyNKI", "46860vuQHlE", "log", "1410039kKBSez", "map", "trim", "text", "includes", "784536GvdPCi"];
  _0x1cde = function () {
    return _0x4beed6;
  };
  return _0x1cde();
...
async function init() {
  ...
  if (_0x119a24[_0x930ee6(210)] === 0) {
    console.warn(_0x930ee6(192));
  }
  document[_0x930ee6(187)](_0x930ee6(193))[_0x930ee6(196)](_0x930ee6(197), function () {
    const _0x22ca09 = _0x930ee6;
    const _0x36879e = this.value[_0x22ca09(183)]();
    let _0x38536f = false;
    for (let _0x2e4e3d = 0; _0x2e4e3d < _0x119a24[_0x22ca09(210)]; _0x2e4e3d++) {
      const _0x4d5ac8 = _0x119a24[_0x2e4e3d];
      if (_0x36879e[_0x22ca09(205)](_0x4d5ac8)) {
        _0x38536f = true;
        break;
      }
    }
    if (_0x38536f) {
      this[_0x22ca09(191)] = "kÃ¼fÃ¼rlÃ¼isim";
    }
  });
}
function _0x1873(_0x4d145d, _0x2e45c0) {
  const _0x1cdea0 = _0x1cde();
  _0x1873 = function (_0x1873e5, _0x1f54f3) {
    _0x1873e5 = _0x1873e5 - 181;
    let _0x397c84 = _0x1cdea0[_0x1873e5];
    return _0x397c84;
  };
  return _0x1873(_0x4d145d, _0x2e45c0);
}
init();
